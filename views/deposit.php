	...
	<main class="body">
		<div class="container-fluid">
			...
			<?php if (Auth::user()->email_verified_at) : ?>
				<form action="<?= controller(AccountController::class) ?>" method="post" id="make-transaction-form" data-final-action="complete-verify-deposit">
					...
					<input type="hidden" name="action" value="init-deposit">
